          ...
          {filteredProfiles.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-6">
              {filteredProfiles.map((profile) => (
                <Link href={`/users/${profile.id}`} key={profile.id}>
                  <div className="group flex flex-col items-center p-5 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl shadow-md transition transform hover:scale-105 hover:shadow-2xl cursor-pointer">
